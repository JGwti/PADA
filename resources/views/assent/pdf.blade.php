    ...
    <table class="table-head" CELLPADDING=10 CELLSPACING=0>
        ...
        <div class="contenedor">
            <p class="p-justificado text-size">
                ...
                @if ( $assent->professional_area=='psychology')
                    x
                @endif
                ) y/o psicopedagogía (

                @if ( $assent->professional_area == 'psychopedagogy')
                    x
                @endif
                ), con
            ...
            <table class="table">
                <tr>
                    {{-- firma de paciente --}}
                    <th class="table">
                        <p><img src="{{ public_path('./storage/signatures/'.$assent->patient_signature) }} " width="100" height="70"></p>
                    </th>
                    {{-- firma representante --}}
                    <th class="table">
                        <p><img src="{{ public_path('./storage/signatures/'.$assent->representative_signature) }}" width="100" height="70"></p>
                    </th>
                </tr>
                ...
                <tr>
                    ...
                    <th class="table">C.C.:
                        <samp class="line-document">
                            {{ $assent->representative_document_number }}
                        </samp>
                    </th>
